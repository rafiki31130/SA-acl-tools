...
2. it declares the command and its three parameters (v4.1 section 7.3) and wires the
   `acltools` core;
...
# (v4.1 section 6.2, bound 4) - which is why this file passes its own `__file__` to the
