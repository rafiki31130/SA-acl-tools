...
`tests/test_message_prefix.py`** rather than a copy of it: v4.1 section 13.2 requires
...
class TheSingleEmissionPointTest(unittest.TestCase):
    """v4.1 section 13.2: one prefix, one emission point, checked mechanically.
...
class TheAdapterCarriesNoBusinessRuleTest(unittest.TestCase):
    """The adapter wires, it does not decide (v4.1 section 14.1, deliverable 1)."""
